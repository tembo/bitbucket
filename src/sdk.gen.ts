 ...
 * would become `%3D`.
 */
export const listUserWorkspaceRepoPermissions = <ThrowOnError extends boolean = false>(options: Options<GetUserWorkspacesByWorkspacePermissionsRepositoriesData, ThrowOnError>) => {
    return (options.client ?? client).get<GetUserWorkspacesByWorkspacePermissionsRepositoriesResponses, GetUserWorkspacesByWorkspacePermissionsRepositoriesErrors, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
